                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody id="items">
                            <?php for ($i = 0; $i < 1; $i++): ?>
                                <tr class="item-row">
                                    <td><?= $this->Form->control("rental_items.$i.reference", ['label' => false, 'class' => 'form-control']) ?></td>
                                    <td><?= $this->Form->control("rental_items.$i.doc_text", ['label' => false, 'class' => 'form-control']) ?></td>
                                    <td><?= $this->Form->control("rental_items.$i.amount", ['label' => false, 'class' => 'form-control']) ?></td>
                                    <td><?= $this->Form->control("rental_items.$i.order_number", ['label' => false, 'class' => 'form-control']) ?></td>
                                    <td><?= $this->Form->control("rental_items.$i.description", ['label' => false, 'class' => 'form-control']) ?></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-danger remove-item">✕</button>
                                    </td>

                                    <?= $this->Form->hidden("rental_items.$i.line_no", ['value' => $i + 1]) ?>
                                    <?= $this->Form->hidden("rental_items.$i.status", ['value' => 1]) ?>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
...
<script>
let index = 1; // start after existing rows if editing
